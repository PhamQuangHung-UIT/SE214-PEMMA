          ...
          backgroundColor: Colors.green,
            bottom: TabBar(
              ...
              indicatorColor: Colors.white,
                tabs:[
                  Tab(
                    text: 'OUTCOME(${cOutcome.length.toString()})'),
                  Tab(
                      text:'INCOME(${cIncome.length.toString()})')
                ],
          ),
        ),
          body: TabBarView(
          ...
          Expanded(
            child: Align(
              ...
              child: SizedBox(
                ...
                height: 30,
                child: IconButton(
                  icon: Image.asset("assets/images/pen-1.png",color: Colors.black),
                  onPressed: () { Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AddCategoryView.existingCategory(category))
                  );},
                ),
              ),
            ),
