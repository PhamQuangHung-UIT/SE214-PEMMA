...
class RequireEmailVerificationView extends StatefulWidget {
  ...
  const RequireEmailVerificationView(this.email, {super.key});
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 5.v),
              Text(
                AppLocalizations.of(context)!.required_email_verification_title,
              ...
              SizedBox(
                height: 250.v,
                child: Text(
                  AppLocalizations.of(context)!.required_email_verification_body,
  ...
  void _continue() {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (_) => SendVerificationEmailView(
            authType: AuthType.signUp, email: widget.email)));
  }
}
